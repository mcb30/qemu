...
#define OHCI1394_INTR_REQ_TX_COMPLETE			0x00000001UL
#define OHCI1394_INTR_RESP_TX_COMPLETE			0x00000002UL
#define OHCI1394_INTR_AR_RQ				0x00000004UL
#define OHCI1394_INTR_AR_RS				0x00000008UL
#define OHCI1394_INTR_RQ_PKT				0x00000010UL
#define OHCI1394_INTR_RS_PKT				0x00000020UL
#define OHCI1394_INTR_ISOCH_TX				0x00000040UL
#define OHCI1394_INTR_ISOCH_RX				0x00000080UL
#define OHCI1394_INTR_POSTED_WRITE_ERR			0x00000100UL
#define OHCI1394_INTR_LOCK_RESP_ERR			0x00000200UL
#define OHCI1394_INTR_SELF_ID_COMPLETE_2		0x00008000UL
#define OHCI1394_INTR_SELF_ID_COMPLETE			0x00010000UL
#define OHCI1394_INTR_BUS_RESET				0x00020000UL
#define OHCI1394_INTR_REG_ACCESS_FAIL			0x00040000UL
#define OHCI1394_INTR_PHY				0x00080000UL
#define OHCI1394_INTR_CYCLE_SYNCH			0x00100000UL
#define OHCI1394_INTR_CYCLE_64_SECONDS			0x00200000UL
#define OHCI1394_INTR_CYCLE_LOST			0x00400000UL
#define OHCI1394_INTR_CYCLE_INCONSISTENT		0x00800000UL
#define OHCI1394_INTR_UNRECOVERABLE_ERROR		0x01000000UL
#define OHCI1394_INTR_CYCLE_TOO_LONG			0x02000000UL
#define OHCI1394_INTR_PHY_REG_RCVD			0x04000000UL
#define OHCI1394_INTR_ACK_TARDY				0x08000000UL
#define OHCI1394_INTR_SOFT_INTERRUPT			0x02000000UL
#define OHCI1394_INTR_VENDOR_SPECIFIC			0x04000000UL
#define OHCI1394_INTR_MASTER_ENABLE			0x80000000UL
...
#define OHCI1394_NODE_ID_CPS				0x08000000UL
#define OHCI1394_NODE_ID_ROOT				0x40000000UL
#define OHCI1394_NODE_ID_ID_VALID			0x80000000UL
